---
title: "Compton Frequency Cross-Ratios on Bruhat-Tits Trees: A Pre-Registered Search for Adelic Structure in the Standard Model Mass Spectrum (Version 2.0)"
...
- Falsifiability: all 15 individual tests pass the null → adelic cross-ratio hypothesis disconfirmed at the tested primes
...
Version 2.0 corrects the methodological failures of version 1.0:
...
The one hint — $\text{CR}(e,\mu,\tau,H) = 976/919$ with $\text{ord}_2 = 4$ — is testable with improved muon, tau, or Higgs mass measurements. If future precision data confirm this rational, it would constitute a genuine signal of $p$-adic geometric structure in the lepton-Higgs sector. Until then, the null hypothesis stands.
